...
void flowPlotter(){
  ...
  Double_t jkk0[10] = {-0.00528349, -0.00716769, -0.000448151, -0.00344702,
    -0.00736325, 0.0094605, 0.012719, -0.00311279, -0.0137632, -0.00629158};
  Double_t jkk1[10] = {-0.0499364, -0.0376796, -0.024832, -0.0391681,
    -0.0338951, -0.0382502, -0.050873, -0.0534457, -0.027967, -0.027604};
  TH1D *h_v2_bin1 = new TH1D("h_v2_bin1","h_v2_bin1",8, -0.1,0.05);
  TH1D *h_v2_bin2 = new TH1D("h_v2_bin2","h_v2_bin2",8, -0.1,0.05);
  for(int i=0;i<10;i++){
